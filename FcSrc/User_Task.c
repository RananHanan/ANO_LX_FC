...
void UserTask_OneKeyCmd(void)
{
    ...
    //static u8 one_key_takeoff_f = 1,mission_step;
    //判断有遥控信号才执行
...
//        }
        ...
        //
        //判断第6通道拨杆位置 1700<CH_6<2200，右拨杆向下3档位置
        ...
        //判断第6通道拨杆位置 800<CH_6<1200，右拨杆向上1档位置
        ...
        ////////////////////////////////////////////////////////////////////////////
        if ((one_key_mission_f == 1) && (my_code_control_flag==1))
        {
			switch(mission_step)
			{
				case 0:
